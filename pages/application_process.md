...
- **Proof of proficiency in English** (if applicable). Please see the step-by-step [application guide]({{site.url}}{{site.baseurl}}/downloads/Application_guidelines_2026_v1.pdf) for further details.
